<%@ Page Language="C#" MasterPageFile="~/JLogin.master" AutoEventWireup="true" CodeFile="JApplied.aspx.cs" Inherits="JApplied" Title="Untitled Page" %>
                                    ...
                                    <tr>
                                        <td class="style11" bgcolor="#D1F3D1" colspan="3">
                                                Comapny Name :<asp:Label ID="lblname" runat="server" CssClass="lbl" 
                                                    ForeColor="#990033" Text='<%#Eval("Cname")%>'></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style15">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                <asp:LinkButton ID="LinkButton9" runat="server" Font-Names="Calibri" 
                                                    Font-Underline="True" ForeColor="#003300" CommandArgument='<%#Eval("AID")%>' >Remove</asp:LinkButton>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="style14">
